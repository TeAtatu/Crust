function LoadDetails(){
    ...
    var emailValue = email.link("mailto:teatatu@hammerhardware.co.nz")
    document.getElementById("contact").innerHTML = "Phone: " + phone + " | Fax: " + fax + " | Email: " + emailValue;
    //document.getElementById("contact").innerHTML = "Phone: 09 834 6210 | Fax: 09 834 9546 | Email: teatatu@hammerhardware.co.nz";
